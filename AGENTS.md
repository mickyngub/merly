...
- `Sources/Merlyn/PanelController.swift` — hidden/open/rail state machine, NSPanel slide animations. Clicking outside collapses to the rail; the chevron tab is the only full dismissal.
